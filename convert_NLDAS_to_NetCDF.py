...
def NLDAS_TXT_TO_NETCDF(basinID):
    for name in glob.glob('main_dir/*'):
        if int(name.split('_')[0]) == int(basinID):
            ...
            directory = '/home/NearingLab/projects/jmframe/CAMELS_synthData/nldas_forcing/'
            ...
            forcing.variables['prec']._FillValue = "1.e+20"
            forcing.variables['prec'].missing_value = "1.e+20"
        
            forcing.createVariable('Tmax', np.float32,('time',))
            forcing.variables['Tmax'].units = 'C'
            forcing.variables['Tmax']._FillValue = "1.e+20"
            forcing.variables['Tmax'].missing_value = "1.e+20"
            ...
            forcing.variables['Tmin']._FillValue = "1.e+20"
            forcing.variables['Tmin'].missing_value = "1.e+20"
